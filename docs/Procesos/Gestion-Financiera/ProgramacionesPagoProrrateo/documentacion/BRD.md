...
## 4. 📊 Resumen de Historias de Usuario

| Historia | Descripción                                | Prioridad               |
| -------- | ------------------------------------------ | ----------------------- |
| HU-08    | Cambios al modelo de datos                 | 🔴 Alta *(prerequisito)* |
| HU-01    | Configuración de prorrateo en contrato     | 🔴 Alta                  |
| HU-03    | Generación automática en primer guardado   | 🔴 Alta                  |
| HU-04    | Generación por Background Service          | 🔴 Alta                  |
| HU-05    | Generación manual con prorrateo            | 🔴 Alta                  |
| HU-06    | Trazabilidad del origen                    | 🟡 Media                 |
| HU-07    | Independencia de programaciones existentes | 🟡 Media                 |
| HU-02    | Bitácora de cambios en prorrateo           | 🟡 Media                 |

---

## 5. 🗂️ Control de Cambios del Documento
...
| 1.1     | DD-MM-YYYY | Nombre             | Ajustes en reglas de negocio (RN-XX)           |
| 1.2     | DD-MM-YYYY | Nombre             | Inclusión de nueva historia de usuario (HU-XX) |
